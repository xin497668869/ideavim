...
public class CommandState {
    ...
    @Nullable
    private static Command ourLastChange = null;
    @NotNull
    private final Stack<State>    myStates       = new Stack<State>();
    @NotNull
    private final State           myDefaultState = new State(Mode.COMMAND, SubMode.NONE, MappingMode.NORMAL);
    @NotNull
    private final List<KeyStroke> myMappingKeys  = new ArrayList<KeyStroke>();
    @NotNull
    private final Timer           myMappingTimer;
    private        char    myLastChangeRegister;
    @Nullable
    private       Command         myCommand;
    @NotNull
    private       ParentNode      myCurrentNode  = VimPlugin.getKey().getKeyRoot(getMappingMode());
    private       int             myFlags;
    ...
    public static boolean inVisualMode(@Nullable Editor editor) {
        ...
        return state.getMode() == Mode.VISUAL;
    }
    ...
    private class State {
        ...
        @NotNull
        private final MappingMode myMappingMode;
        @NotNull
        private       SubMode     mySubMode;
