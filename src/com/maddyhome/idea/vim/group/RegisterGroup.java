...
public class RegisterGroup {
    ...
    @NotNull
    private final HashMap<Character, Register> registers       = new HashMap<Character, Register>();
    ...
    public boolean storeText(@NotNull Editor editor,
        ...
        if (isRegisterWritable()) {
            ...
            //  return true;
            //}
            TextBlockTransferable transferable = getTransferable(editor, range, type, editor.getCaretModel().getCurrentCaret());
    ...
    public TextBlockTransferable getTransferable(final Editor editor, TextRange range, SelectionType type, Caret caret) {
...
//    String rawText = TextBlockTransferable.convertLineSeparators(text, "\n", transferableDatas);
        ...
        final TextBlockTransferable transferable =
