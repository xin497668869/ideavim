...
public class MarkGroup {
    ...
    @NotNull
    private final HashMap<String, FileMarks<Character, Mark>> fileMarks   = new HashMap<String, FileMarks<Character, Mark>>();
    @NotNull
    private final HashMap<Character, Mark>                    globalMarks = new HashMap<Character, Mark>();
    @NotNull
