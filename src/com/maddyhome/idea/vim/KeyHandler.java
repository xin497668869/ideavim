...
import com.maddyhome.idea.vim.jpane.VimCommandStatusBarWidget;
...
public class KeyHandler {
    ...
    @NotNull
    private final  Stack<Command>     currentCmd = new Stack<Command>();
    private        int                count;
    private        List<KeyStroke>    keys;
    private        State              state;
    @NotNull
    private        Argument.Type      currentArg;
    ...
    public void handleKey(@NotNull Editor editor,
        ...
        VimCommandStatusBarWidget.updateVimCommandStatusBar(editor.getProject(), key.getKeyChar());
                ...
                if (cmd.getType().isWrite()) {
                    ...
                    if (CommandState.getInstance(editor).getMode() == CommandState.Mode.VISUAL) {
                        ...
                        if (editor.getProject() != null) {
                            ...
                            UndoManager.getGlobalInstance().undoableActionPerformed(vimUndoableAction);
                        }
                    } else if (!"Vim Exit Insert Mode".equals(name) &&
                            !"Vim Undo".equals(name) &&
                            !"Vim Up".equals(name) &&
                            !"Vim Backspace".equals(name) &&
                            !"Vim Down".equals(name) &&
                            !"Vim Left".equals(name) &&
                            !"Vim Right".equals(name) &&
